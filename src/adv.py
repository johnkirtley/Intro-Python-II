...
room = {
    'outside':  Room("Outside Cave Entrance",
                     "North of you, the cave mount beckons", ['foyer', None, None, None], ['shovel']),
...
the distance, but there is no way across the chasm.""", [None, 'foyer', None, None], ['binoculars']),
...
earlier adventurers. The only exit is to the south.""", [None, 'narrow', None, None], ['treasure chest'])
}
